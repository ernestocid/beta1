...
public class TestMachineBuilder {
	...
	private void addConstants(StringBuffer testMachine) {
		if(this.operation.getMachine().getConstants() != null) {
			testMachine.append(this.operation.getMachine().getConstants().toString());
			testMachine.append("\n");
		}
	}
...
//		
//		addConstantsFromAllDependantMachines(this.operation.getMachine(), constants);
//		
...
//		
//		addPropertiesFromAllDependantMachines(this.operation.getMachine(), properties);
//		
...
//	 * 		- SEES;
//	 * 		- INCLUDES (Transitive: should also check for machines included by the included machine);
...
//		
//		addDefinitionsFromAllDependantMachines(this.operation.getMachine(), definitions);
//		
