...
public class ActiveClauseCoverageTest {
	...
	public void shouldGenerateTestFormulasForAnyStatement2() {
		...
		expectedTestFormulas.add("((!(ii,jj).((ii : 0..9 & jj : 0..9) => (((ii /= jj) => (vector(ii) /= vector(jj))))) & ((descending_sort = TRUE) => (!(ii).((ii : 0..8) => (vector(ii) > vector((ii + 1)))))) & descending_sort : BOOL & vector : (0..9 --> 0..10)) & (descending_sort = FALSE) & (!(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1))))) & ((sorted_vector : (0..9 --> 0..10) & 1=1 & ran(sorted_vector) = ran(vector)) <=> not(sorted_vector : (0..9 --> 0..10) & 1=2 & ran(sorted_vector) = ran(vector))))");
		expectedTestFormulas.add("((!(ii,jj).((ii : 0..9 & jj : 0..9) => (((ii /= jj) => (vector(ii) /= vector(jj))))) & ((descending_sort = TRUE) => (!(ii).((ii : 0..8) => (vector(ii) > vector((ii + 1)))))) & descending_sort : BOOL & vector : (0..9 --> 0..10)) & (descending_sort = FALSE) & not(ran(sorted_vector) = ran(vector)) & ((sorted_vector : (0..9 --> 0..10) & !(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1)))) & 1=1) <=> not(sorted_vector : (0..9 --> 0..10) & !(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1)))) & 1=2)))");
		expectedTestFormulas.add("((!(ii,jj).((ii : 0..9 & jj : 0..9) => (((ii /= jj) => (vector(ii) /= vector(jj))))) & ((descending_sort = TRUE) => (!(ii).((ii : 0..8) => (vector(ii) > vector((ii + 1)))))) & descending_sort : BOOL & vector : (0..9 --> 0..10)) & (descending_sort = FALSE) & (ran(sorted_vector) = ran(vector)) & ((sorted_vector : (0..9 --> 0..10) & !(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1)))) & 1=1) <=> not(sorted_vector : (0..9 --> 0..10) & !(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1)))) & 1=2)))");
		expectedTestFormulas.add("((!(ii,jj).((ii : 0..9 & jj : 0..9) => (((ii /= jj) => (vector(ii) /= vector(jj))))) & ((descending_sort = TRUE) => (!(ii).((ii : 0..8) => (vector(ii) > vector((ii + 1)))))) & descending_sort : BOOL & vector : (0..9 --> 0..10)) & (descending_sort = FALSE) & not(!(ii).((ii : 0..8) => (sorted_vector(ii) > sorted_vector((ii + 1))))) & ((sorted_vector : (0..9 --> 0..10) & 1=1 & ran(sorted_vector) = ran(vector)) <=> not(sorted_vector : (0..9 --> 0..10) & 1=2 & ran(sorted_vector) = ran(vector))))");
