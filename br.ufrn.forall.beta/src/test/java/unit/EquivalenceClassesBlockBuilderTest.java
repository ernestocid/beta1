...
//import main.EquivalenceClassesBlockBuilder;
...
//
//public class EquivalenceClassesBlockBuilderTest {
//		
//	@Test
...
//		EquivalenceClassesBlockBuilder blockBuilder = new EquivalenceClassesBlockBuilder(partitioner);
//		
...
//		ch4Blocks.add("hh : MININT..1 - 1");
//		ch4Blocks.add("hh : 163 + 1..MAXINT");
//		ch4Blocks.add("hh : 1..163");
//		
...
//		ch6Blocks.add("ff : MININT..1 - 1");
//		ch6Blocks.add("ff : 5 + 1..MAXINT");
...
//		
//		
//		// Expression not subset of another expression
//		
//		List<String> ch9Blocks = new ArrayList<String>();
...
//		
//		List<String> ch5Blocks = new ArrayList<String>();
//		ch5Blocks.add("ii : NAT");
//		ch5Blocks.add("not(ii : NAT)");
//		
...
//		
//		List<String> ch7Blocks = new ArrayList<String>();
//		ch7Blocks.add("jj : NAT");
//		ch7Blocks.add("not(jj : NAT)");
//		
...
//		
//		List<String> ch8Blocks = new ArrayList<String>();
//		ch8Blocks.add("kk : NAT");
//		ch8Blocks.add("not(kk : NAT)");
//		
...
//		
//		List<String> ch10Blocks = new ArrayList<String>();
//		ch10Blocks.add("ll : NAT");
//		ch10Blocks.add("not(ll : NAT)");
//		
...
//		
//		List<String> ch3Blocks = new ArrayList<String>();
//		ch3Blocks.add("cc : NAT");
//		ch3Blocks.add("not(cc : NAT)");
//				
...
//		
//		List<String> ch2Blocks = new ArrayList<String>();
//		ch2Blocks.add("bb : NAT");
//		ch2Blocks.add("not(bb : NAT)");
//		
...
//		Machine machine = new Machine(new File("machines/LogFile/LogFile.mch"));
//		Operation operationUnderTest = machine.getOperation(0);
//		EquivalenceClassesBlockBuilder ecBlockBuilder = new EquivalenceClassesBlockBuilder(new Partitioner(operationUnderTest));
//
//		Map<String, List<String>> expectedBlocks = new HashMap<String, List<String>>();
//		List<String> ch1Blocks = new ArrayList<String>();
//		ch1Blocks.add("log_file <: LOG");
//		
//		expectedBlocks.put("log_file <: LOG", ch1Blocks);
//		
//		assertEquals(expectedBlocks, ecBlockBuilder.getBlocks());
//	}
//	
//	
//	
...
//		
//		List<String> ch5Blocks = new ArrayList<String>();
//		ch5Blocks.add("value : MININT..0 - 1");
//		ch5Blocks.add("value : MAXINT - 1 + 1..MAXINT");
//		ch5Blocks.add("value : 0..MAXINT - 1");
//		
...
//		Machine machine = new Machine(new File("machines/others/counter.mch"));
//		Operation operationUnderTest = machine.getOperation(1);
//
//		Partitioner partitioner = new Partitioner(operationUnderTest);
//		EquivalenceClassesBlockBuilder blockBuilder = new EquivalenceClassesBlockBuilder(partitioner);
...
//		List<String> ch2Blocks = new ArrayList<String>();
//		ch2Blocks.add("value <= MAXINT");
//		ch2Blocks.add("not(value <= MAXINT)");
//		
//		expectedBlocks.put("value <= MAXINT", ch2Blocks);
//		
//		
...
//		
//		List<String> ch5Blocks = new ArrayList<String>();
//		ch5Blocks.add("value : INT");
//		
//		expectedBlocks.put("value : INT", ch5Blocks);
//		
//		
//		List<String> ch6Blocks = new ArrayList<String>();
//		ch6Blocks.add("((overflow = TRUE) => (value = MAXINT))");
//		
