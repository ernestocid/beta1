...
public class EquivalenceClassesTestTypingCharacteristics {
	...
	public void findBlocksForIsTotalFunction_returnsisTotalFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isTotalFunction);
	...
	public void findBlocksForIsPartialFunction_returnsisPartialFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isPartialFunction);
	...
	public void findBlocksForIsInjectiveFunction_returnsisInjectiveFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isInjectiveFunction);
	...
	public void findBlocksForIsTotalSurjectiveFunction_returnsisTotalSurjectiveFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isTotalSurjectiveFunction);
	...
	public void findBlocksForIsPartialSurjectiveFunction_returnsisPartialSurjectiveFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isPartialSurjectiveFunction);
	...
	public void findBlocksForIsBijectiveFunction_returnsIsBijectiveFunctionBlock() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, isBijective);
	...
	public void findBlocksForBelongsToEnumeratedSet_returnsBelongsAndNotBelongsBlocks() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, belongsToEnumeratedSet);
	...
	public void findBlocksForBelongsToSTRING_returnsBelongsSTRING() {
		...
		Characteristic characteristic = new ArrayList<Characteristic>(partitioner.getCharacteristicsFromPrecondition()).get(0);
		Set<Block> actualResult = EquivalenceClasses.findBlocks(characteristic, belongsToSTRING);
