...
public class GenerateCBCTestsCommandTest {
	...
	public void shouldGenerateCBCTestsXMLFile() {
		File machine = new File("src/test/resources/machines/others/test_Course_student_pass_or_fail_CBCTest.mch");
		String outputXML = "src/test/resources/machines/others/cbc_test.xml";
		...
		String actualXML = FileTools.getFileContent(new File(outputXML));
