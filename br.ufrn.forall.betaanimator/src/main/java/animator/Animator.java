...
public class Animator {
	...
	private String[] animationCommand() {
		String[] command = new String[] {
				...
				"1",
				"-p",
				"RANDOMISE_ENUMERATION_ORDER",
				String.valueOf(Configurations.getRandomiseEnumerationOrder()).toUpperCase(),
				"-p",
				"KODKOD",
				String.valueOf(Configurations.getUseKodkod()).toUpperCase(),
				"-p",
				"TIME_OUT",
