...
public class ReadMachineInfoTest {
	...
	public void shouldGetInvariant() {
		String expectedInvariant = "cab_consol_open_button_pushed : BOOL & " + "cab_side_open_button_pushed : BOOL & "
				+ "cab_consol_close_button_pushed : BOOL & " + "cab_side_close_button_pushed : BOOL & " + "foo : BOOL & " + "test_variable <: NAT1 & "
				+ "test_variable2 <: NAT1 & " + "test_variable3 <: NAT1 & " + "((test_variable2 = test_variable) => (test_variable3 /= test_variable)) & "
	...
	@Test
	public void shouldGetAllConstantsFromExtendedMachines_returnsConstantsFromMachinesExtendedInATransitiveWay() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestExtendsMachineC.mch");

		// Setting up expected results

		Set<String> expectedConstants = new HashSet<String>();
		expectedConstants.add("constantA");
		expectedConstants.add("constantB");
		expectedConstants.add("constantC");

		// Assertions

		assertEquals(expectedConstants, machine.getConstantsFromAllMachines());
	}



	@Test
	public void shouldGetAllConstantsFromSeenMachines_returnsConstantsFromMachinesSeenNotTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestSEESMachineC.mch");
	...
	@Test
	public void shouldGetAllConstantsFromIncludedMachines_returnsConstantsFromMachinesIncludedTransitively() {
		...
		expectedConstants.add("constantB");
		expectedConstants.add("constantC");
		expectedConstants.add("constantD");
	...
	@Test
	public void shouldGetAllConstantsFromUsedMachines_returnsConstantsFromMachinesUsedNotTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestUsesMachineC.mch");
	...
	@Test
	public void shouldGetAllVariablesFromUsedMachines_returnsVariablesFromMachinesUsedNotTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestUsesMachineC.mch");

		// Setting up expected results

		Set<String> expectedConstants = new HashSet<String>();
		expectedConstants.add("varB");
		expectedConstants.add("varC");

		// Assertions

		assertEquals(expectedConstants, machine.getVariablesFromAllMachines());
	}



	@Test
	public void shouldGetAllVariablesFromSeenMachines_returnsVariablesFromMachinesSeenNotTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestSEESMachineC.mch");
	...
	@Test
	public void shouldGetAllVariablesFromIncludedMachines_returnsVariablesFromMachinesIncludedTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestIncludeMachineC.mch");

		// Setting up expected results

		Set<String> expectedConstants = new HashSet<String>();
		expectedConstants.add("varA");
		expectedConstants.add("varB");
		expectedConstants.add("varC");
		expectedConstants.add("varD");
	...
	@Test
	public void shouldGetAllVariablesFromExtendedMachines_returnsVariablesFromMachinesExtendedTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestExtendsMachineC.mch");
	...
	@Test
	public void shouldGetAllVariablesFromIncludedMachinesThatExtendAnotherMachine_returnsVariablesFromMachinesIncludedAndExtendedTransitively() {
		Machine machine = getMachineInstance("src/test/resources/machines/others/TestIncludeMachineC.mch");
